...
type
  ...
  private
    ...
    function tipoFinanciamentoInt(forma: PARCELAMENTO_TYPE): string;
...
begin
  bridge_instance.ConsultarStatus(edtIP.Text,
                                            edtTrasacao.Text,
                                            edtStatus.Text,
                                            edtSenha.Text,
                                            Retorno);
...
function TFrmBridge.tipoFinanciamentoInt(forma: PARCELAMENTO_TYPE):string;
begin
  // 1 - A vista
  // 2 - ADM
  // 3 - Loja
...
begin
  ...
  if TRegEx.IsMatch(edtValor.Text, '^([1-9]\d+)(\,\d{1,2})?$') then
    bridge_instance.IniciaCancelamentoVenda(IdTransacao,
                                            PDV,
                                            novo_valor,
...
//                                strtoint(edtStatus.Text));
    case frmDialogOpAdm.Op of
      ADMINISTRACAO:
        bridge_instance.IniciaOperacaoAdministrativa(idTransacao, '0', PDV, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      INSTALACAO:
        bridge_instance.IniciaOperacaoAdministrativa(idTransacao, '1', PDV, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      CONFIGURACAO:
        bridge_instance.IniciaOperacaoAdministrativa(idTransacao, '2', PDV, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      MANUTENCAO:
        bridge_instance.IniciaOperacaoAdministrativa(idTransacao, '3', PDV, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      COMUNICACAO:
        bridge_instance.IniciaOperacaoAdministrativa(idTransacao, '4', PDV, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      COMPROVANTE:
        bridge_instance.IniciaOperacaoAdministrativa(idTransacao, '5', PDV, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
    end;
  end);
...
begin
  frmDialogConfigSenha.EscolherItem(
    ...
    begin
      ...
      bridge_instance.SetSenhaServer(frmDialogConfigSenha.edtSenha.Text, senhaHabilitada,
                                    edtIP.Text, edtTrasacao.Text, edtStatus.Text,
                                    Retorno);
    ...
    begin
      ...
      bridge_instance.SetSenhaServer('', senhaHabilitada,
                                    edtIP.Text, edtTrasacao.Text, edtStatus.Text,
                                    Retorno);
...
begin
  ...
  Procedure
  begin
    bridge_instance.AtualizarTimeout(frmDialogTimeout.ValorTimeout, edtIP.Text, edtTrasacao.Text, edtStatus.Text,
                                    edtSenha.Text, Retorno);
  end);
...
begin
  bridge_instance.ConsultarTimeout(edtIP.Text, edtTrasacao.Text, edtStatus.Text,
                                    edtSenha.Text, Retorno);
end;
...
begin
  ...
  bridge_instance.ConsultarUltimaTransacao(PDV, edtIP.Text, edtTrasacao.Text, edtStatus.Text,
                                    edtSenha.Text, Retorno);
end;
...
begin
  ...
  begin
      ...
      begin
        bridge_instance.IniciaVendaCredito(IdTransacao, tipoFinanciamentoInt(TipoDeParcelamento),
                                                      edtParcelas.Text,
                                                      PDV, novo_valor,edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      end
      ...
      begin
        bridge_instance.IniciaVendaDebito(IdTransacao, PDV, novo_valor,edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      end;
  end;
...
begin
  ...
  begin
    case frmDialogCupom.Cupom of
      NFCE:
        bridge_instance.ImprimirCupomNfce(CSC_EXEMPLO, INDEXCSC_EXEMPLO, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      SAT:
        bridge_instance.ImprimirCupomSat(edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
      SATCANCEL:
        bridge_instance.ImprimirCupomSatCancelamento(ASS_QR_CODE_EXEMPLO, edtIP.Text,
                                                      edtTrasacao.Text, edtStatus.Text,
                                                      edtSenha.Text, Retorno);
    end;
  end);
...
procedure TFrmBridge.Retorno(msg: string);
begin
  ShowMessage(msg);
end;
