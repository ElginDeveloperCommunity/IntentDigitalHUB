...
import com.elgin.intent_digital_hub.Activities.ActivityUtils.startNewActivity
import androidx.appcompat.app.AppCompatActivity
import android.widget.LinearLayout
import android.os.Bundle
import com.elgin.intent_digital_hub.Activities.Bridge.BridgeActivity
import com.elgin.intent_digital_hub.Activities.Printer.PrinterActivity
import com.elgin.intent_digital_hub.Activities.SAT.SATActivity
import androidx.core.app.ActivityCompat
import android.content.pm.PackageManager
import android.widget.Toast
import android.os.Build
import android.view.View
import com.elgin.intent_digital_hub.Activities.Balanca.BalancaActivity

class MainActivity : AppCompatActivity() {
    private lateinit var buttonBridge: LinearLayout
    private lateinit var buttonPrinter: LinearLayout
    private lateinit var buttonBalance: LinearLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonBalance = findViewById(R.id.buttonBalanca)
        buttonSat = findViewById(R.id.buttonSAT)

        buttonBridge.setOnClickListener {
            startNewActivity(this, BridgeActivity::class.java)
        }

        buttonPrinter.setOnClickListener { v: View? ->
            startNewActivity(this, PrinterActivity::class.java)
        }

        buttonBalance.setOnClickListener {
            startNewActivity(this, BalancaActivity::class.java)
        }

        buttonSat.setOnClickListener { v: View? ->
            startNewActivity(this, SATActivity::class.java)
        }
