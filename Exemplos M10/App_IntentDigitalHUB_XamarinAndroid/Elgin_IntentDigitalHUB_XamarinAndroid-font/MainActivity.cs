...
using Xamarin_Android_Intent_Digital_Hub.Balanca;
...
namespace Xamarin_Android_Intent_Digital_Hub
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            buttonBalance = FindViewById<LinearLayout>(Resource.Id.buttonBalanca);
            ...
            buttonBalance.Click += delegate { ActivityUtils.StartNewActivity(this, typeof(BalancaActivivty)); };
